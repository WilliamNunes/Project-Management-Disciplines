      ...
      <div class="form-bottom">
        <?php echo $this->Form->create('Paciente', array('url' => 'index_cadastro' ));?>
          <div class="form-group">
            ...
            <?php echo $this->Form->input('nome', array('placeholder' => 'Digite seu nome...', 'rule' => 'notEmpty', 'required' => true , 'class' => 'form-text form-control', 'label' => '')); ?>
          </div>
          <div class="form-group">
          ...
          <br/><center><a href="<?php echo Router::url(array('controller' => 'pacientes', 'action' => 'index_login')); ?>">Voltar</a></center>
      </div>
    </div>
