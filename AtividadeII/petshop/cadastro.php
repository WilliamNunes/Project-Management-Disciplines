  ...
  <head>
      ...
      <title> Cadastro - PetShop - CatDog  </title>
          ...
          <div class="row">
              <div class="col-sm-6 col-sm-offset-3 form-box">
                ...
                <div class="form-bottom">
                  <form class="login-form" id="form" name="form" method="post" action="cadastrar.php">
                    <div class="form-group">
                      <p><strong>Nome:</strong></p>
                      <input type="text" name="nome" placeholder="Digite o seu nome" class="form-username form-control" id="nome">
                    </div>
                    <div class="form-group">
